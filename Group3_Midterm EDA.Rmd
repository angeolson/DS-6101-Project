...
Some of the key factors that influence a total home value are missing from this dataset. While not all factors that affect home value for a buyer or long-term renter, such as schools, will affect those looking for an AirBnB, it is expected that costs that the owner of the AirBnB faced will be passed on to consumers to help the owner profit off of listing their unit. An example of this is square footage(1), or more importantly, actual usable space of this square footage. Especially in a city like New York(2), this comes at a premium and would be expected to have an impact on price.

**still need to cite, reminder to do this later**
Cite 1: https://www.opendoor.com/w/blog/factors-that-influence-home-value
Cite 2: https://www.rentcafe.com/blog/apartment-search-2/the-tiniest-rentals-in-new-york-city-if-%E2%89%88300-sq-ft-is-just-what-you-need/ 
